...
import com.heartyculture.app.R
    ...
    fun invoke(
        ...
        if (isSeparateOut) {
            ...
            if (isMaskOut) {
                ...
                results.forEach {
                    applyTransparentOverlay(
                            context,
                            combined,
                            it,
                            colorPairs[it.box.cls] ?: R.color.primary
                    )
                }
                        ...
                        when (maskValue) {
                            ...
                            0 -> Color.BLACK
                                    ...
                                    throw IllegalArgumentException(
                                            "Mask values must be either 0.0 or 255.0"
                                    )
                        }
